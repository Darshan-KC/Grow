...
@section('title', 'Grow - Testimonials')
                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="bg-light p-5">
                            ...
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
                                <img class="img-fluid mr-4" src="{{ asset('uploads/extra/testimonial-2.jpg') }}"
                                    alt="" />
                                <div>
                                    <h5>Student Name</h5>
                        ...
                        <div class="bg-light p-5">
                            ...
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
                                <img class="img-fluid mr-4" src="{{ asset('uploads/extra/testimonial-1.jpg') }}"
                                    alt="" />
                                <div>
                                    <h5>Student Name</h5>
                                    <span>Web Design</span>
